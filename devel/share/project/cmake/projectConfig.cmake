...
if("TRUE" STREQUAL "TRUE")
  set(project_SOURCE_PREFIX /home/utsavshah/finalProject/src/project)
  set(project_DEVEL_PREFIX /home/utsavshah/finalProject/devel)
  set(project_INSTALL_PREFIX "")
  set(project_PREFIX ${project_DEVEL_PREFIX})
else()
  set(project_SOURCE_PREFIX "")
  set(project_DEVEL_PREFIX "")
  set(project_INSTALL_PREFIX /home/utsavshah/finalProject/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'utsavshah <utsavshah@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'project' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/utsavshah/finalProject/src/project/${idir}'.  Ask the maintainer 'utsavshah <utsavshah@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/utsavshah/finalProject/devel/lib;/opt/ros/kinetic/lib)
